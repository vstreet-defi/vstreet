...
function Features({ isMobile }: Props) {
  return (
    <Container p="0" maxW="100vw" bgGradient="linear(to-l, #121215 ,#284736)">
      <Box w="100%" bgImg={bg} bgRepeat="no-repeat" bgPos="center" bgSize="cover">
        <Stack
          ...
          <Flex flex={1} justify="center" align="center" position="relative" w="100%" flexDir="column">
            <Heading
            ...
            <Text
              ...
              <br /> <br></br>
              Our streamlined platform offers secure, transparent lending, giving you the flexibility to enhance your
              investment strategies effectively.
            </Text>
          </Flex>

          <Stack flex={1} spacing={{ base: 5, md: 10 }} mr={{ md: '0', lg: '8rem' }}>
