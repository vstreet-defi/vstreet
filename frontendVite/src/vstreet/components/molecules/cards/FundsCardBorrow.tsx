    ...
    <div className={styles.fundsCard}>
      <div className={styles.inputSection}>
        <div className={styles.availableBalance}>
          {isBorrow ? 'Available to Borrow' : isPay ? 'Current Debt' : 'Available'}:{' '}
          <span>
        ...
        <div className={styles.inputRow}>
          ...
          <div className={styles.inputWrapper}>
            ...
            <BasicInput inputValue={inputValue} onInputChange={handleInputChange} balance={getActiveBalance()} />
          </div>
        </div>

        <PercentageSelector inputValue={inputValue} onInputChange={handleInputChange} balance={getActiveBalance()} />
      </div>

      <ButtonGradFillBorrow amount={inputValue} label={buttonLabel} balance={getActiveBalance()} />
    </div>
  );
}
