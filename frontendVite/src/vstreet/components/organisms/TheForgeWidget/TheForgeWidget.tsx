...
import { formatWithCommasVARA } from 'utils/index';
...
const MATURITY_OPTIONS = [
  ...
  { id: '90D', term: '90D', discount: '30%', multiplier: 1.3, vibe: 'SUPERNOVA FORGE' },
];
      ...
      <div className={styles.grid}>
        <div className={styles.controls}>
          <div className={styles.inputArea}>
            ...
            <div className={styles.warning}>Forging involves a maturity period. Tokens release linearly over time.</div>
          </div>
        ...
        <div className={styles.projectionArea}>
          ...
          <div className={styles.projectionBody}>
            ...
            <div className={styles.unifiedBar}>
              <div className={styles.dexFill} style={{ width: amount ? '70%' : '0%' }}>
