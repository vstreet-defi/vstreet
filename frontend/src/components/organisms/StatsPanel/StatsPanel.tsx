...
const StatsPanel: React.FC = () => {
    ...
    useEffect(() => {
        if (selectedAccount) {
            ...
            const balanceNum = Number(balanceConverted) / 1000000;
            setFormatBalanceVUSD(formatWithCommasVUSD(balanceNum));
        } else {
        ...
        <div className={styles.walletCard}>
            ...
            <div className={styles.stats}>
                <div className={styles.statItem}>
                    ...
                    <p className={styles.statValue}>{formatBalanceVUSD} vUSD</p>
                </div>

                <div className={styles.statItem}>
                    <p className={styles.statLabel}>TOTAL LIQUIDITY POOL</p>
                    <p className={styles.statValue}>$3,000,001 vUSD</p>
                </div>
