...
// Removed unused import: Flex
import {
  RiGovernmentLine,
  RiFireLine,
  RiArrowRightSLine,
} from "react-icons/ri";
// Removed unused import: RiRobotLine
...
const modules = [
  {
    ...
    description:
      "Adaptive issuance and controlled growth through strategic emission caps.",
    features: [
  ...
  },
  {
    ...
    description:
      "Strategic allocation to drive liquidity, growth, and community governance.",
    features: [
  ...
  },
  {
    ...
    icon: RiFireLine,
    description:
      "Value Capture through multi-layered deflationary pressure and AI synergy.",
    features: [
          ...
          {modules.map((module, index) => (
            <Box key={index} className={styles.engineModule}>
              ...
              <div className={styles.content}>
                ...
                <Text className={styles.moduleDescription}>
                  {module.description}
                </Text>
                ...
                <ul className={styles.featureList}>
                  {module.features.map((feature, idx) => (
                    <li key={idx} className={styles.featureItem}>
                      <span>
                        <Icon as={RiArrowRightSLine as ElementType} />
                      </span>
                      {feature}
                    </li>
                  ))}
